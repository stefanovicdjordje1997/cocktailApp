...
class TabBarController: UITabBarController {
    ...
    func setupTabBar() {
        ...
        appearance.stackedLayoutAppearance.selected.titleTextAttributes = [.foregroundColor: UIColor.white, .font: UIFont.customFontRegularSmall]
        appearance.stackedLayoutAppearance.normal.titleTextAttributes = [.foregroundColor: UIColor.white, .font: UIFont.customFontRegularSmall]
    ...
    func setupNavBar() {
        ...
        let attributes = [NSAttributedString.Key.font: UIFont.customFontBoldLarge, NSAttributedString.Key.foregroundColor: UIColor.black]
        let appearance = UINavigationBarAppearance()
        
        appearance.configureWithOpaqueBackground()
        appearance.backgroundColor = .primaryLight
        appearance.titleTextAttributes = [NSAttributedString.Key.font: UIFont.customFontBoldLarge]
