...
class ProfileViewController: UIViewController {
    ...
    @objc func enableEmailEdit() {
        if !isEmailEnabled {
            ...
            emailEditButton.setImage(UIImage(systemName: "square.and.arrow.down"), for: .normal)
            isEmailEnabled = true
    ...
    @objc func enablePasswordEdit() {
        if !isPasswordEnabled {
            ...
            passwordEditButton.setImage(UIImage(systemName: "square.and.arrow.down"), for: .normal)
